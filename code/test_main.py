...
def Hill_Climber(nr_of_houses):
	...
	for i in range(nr_of_changes):
		worth = 0
		new_coordinate_list = (randomChange(current_coordinate_list, nr_of_houses, grid)[0])
		new_grid = (randomChange(current_coordinate_list, nr_of_houses, grid)[1])
...
def randomChange(coordinate_list, nr_of_houses, grid):
